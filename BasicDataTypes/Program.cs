...
static void UseDateAndTimes()
{
    ...
    //The constructor takes (hours, minutes, seconds)
    ...
    //How to get date/time only depending on selected
...
static void UseBigInteger()
{
    ...
    Console.WriteLine("Value of bigger is {0}", biggy);
    Console.WriteLine("Is biggy an even value?: {0}", biggy.IsEven);
    Console.WriteLine("Is biggy a power of 2?: {0}", biggy.IsPowerOfTwo);
    BigInteger reallyBig = BigInteger.Multiply(biggy,
        BigInteger.Parse("8888888888888888888888888888888888888888888888"));
